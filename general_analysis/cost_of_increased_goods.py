...
def cost_of_increased_goods():
    ...
    if conn.is_connected():
        ...
        try:
            ...
            CREATE TABLE IF NOT EXISTS purchase_increased_processed_tables (
            ...
            WHERE table_name LIKE 'increased_products_%_products_%'
                AND table_name NOT IN (SELECT table_name FROM purchase_increased_processed_tables);
            """
            ...
            for table in tables:
                ...
                ADD COLUMN cost_of_increased_goods DECIMAL(10, 2);
                """
                ...
                update_query = f"""
                UPDATE {table_name}
                SET cost_of_increased_goods = quantity_increased * price;
                """
                ...
                insert_log_query = "INSERT INTO purchase_increased_processed_tables (table_name) VALUES (%s);"
