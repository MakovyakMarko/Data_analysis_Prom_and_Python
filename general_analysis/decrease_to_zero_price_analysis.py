# -*- coding: utf-8 -*-
"""
Created on Mon Sep 25 18:34:08 2023
...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 25 18:11:07 2023
...
def decrease_to_zero_price_analysis():
    ...
    if conn.is_connected():
        ...
        try:
            ...
            CREATE TABLE IF NOT EXISTS decreased_to_zero_price_processed_tables (
            ...
            WHERE table_name LIKE 'quantity_products_%_products_%'
                AND table_name NOT IN (SELECT table_name FROM decreased_to_zero_price_processed_tables);
            """
            ...
            for table in tables:
                ...
                update_query = f"""
                UPDATE {table_name}
                SET profit = previous_quantity * previous_price;
                """
                ...
                insert_log_query = "INSERT INTO decreased_to_zero_price_processed_tables (table_name) VALUES (%s);"
...
if __name__ == "__main__":
    decrease_to_zero_price_analysis()